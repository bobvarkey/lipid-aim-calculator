    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur-md">
        <div className="mx-auto flex max-w-md items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            {session ? (
              <Button size="sm" variant="ghost" onClick={signOut} className="h-8 gap-1.5 text-xs" title={session.user?.email ?? ""}>
                <LogOut className="h-3.5 w-3.5" /> Sign out
              </Button>
            ) : (
              <>
                <Button size="sm" variant="outline" onClick={signInWithGoogle} className="h-8 gap-1.5 text-xs" title="Sign in with Google">
                ...
                <Button size="sm" variant="outline" onClick={signInWithApple} className="h-8 gap-1.5 px-2 text-xs" title="Sign in with Apple">
                  <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.6-2.2.44-3.06-.4C2.95 15.18 4.03 7.91 9.18 7.52c1.25.1 2.13.65 2.86.65.76 0 1.95-.7 3.28-.6 1.1.09 2.05.49 2.76 1.21-2.48 1.45-2.04 5.25.4 6.3-.47 1.45-1.1 2.88-2.43 4.4zM12.03 7.25c-.15-2.55 2.11-4.69 4.59-4.75.28 2.74-2.43 5.03-4.59 4.75z"/>
                  </svg>
                </Button>
              </>
            )}
